...
const ApplyCancel = (e) => {
    ...
    console.log('当前任务总数据',apply,applyCount)
    ...
    return (
        <div className='ApplyCancel'>
           ...
           <div className='navText'><Text strong className='navFont'>已驳回的任务</Text></div>
            <div className='navFinish' >
                {/* <Text>您目前暂无申请</Text> */}
                <Text>您目前有<span style={{color:'red'}}>{applyCount}</span>条已驳回任务</Text>
                
                <div style={{display:'flex',flexDirection:'column'}}>
                <Link to='/index/task2' className='ApplyCancel-link' ><Button className='ApplyCancel-btn' type='danger'>返回</Button></Link>
                    </div>
