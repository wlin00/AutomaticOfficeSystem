...
import ApplyIndex2 from './ApplyIndex2/ApplyIndex'
import ApplyCancel2 from './ApplyCancel2/ApplyCancel'
import ApplyDeal2 from './ApplyDeal2/ApplyDeal'
...
const Task2 = (e) => {
    ...
    return (
        ...
        <Route path='/index/task2' exact component={ApplyIndex2} />
        <Route path='/index/task2/deal' exact component={ApplyDeal2} />
        <Route path='/index/task2/cancel' exact component={ApplyCancel2} />
