...
import '../ApplyDeal/ApplyDeal.scss'
...
const ApplyDeal = (e) => {
    ...
    return (
        <div className='ApplyDeal'>
           ...
           <div className='navText'><Text strong className='navFont'>已通过的申请</Text></div>
            <div className='navFinish' >
                {/* <Text>您目前暂无申请</Text> */}
                <Text>您目前有<span style={{color:'red'}}>{applyCount}</span>条已通过申请</Text>
                
                <div style={{display:'flex',flexDirection:'column'}}>
                <Link to='/index/trackProcess' className='ApplyDeal-link' ><Button className='ApplyDeal-btn' type='danger'>返回</Button></Link>
                    </div>
